            ...
            call.enqueue(object : Callback<AlimentoOutput> {
                override fun onResponse(call: Call<AlimentoOutput>, response: Response<AlimentoOutput>) {
                    ...
                    if(response.isSuccessful) {
                        ...
                        dialogView.findViewById<Button>(R.id.fragmentAdicionarAlimentoAddBtn).setOnClickListener {
                            ...
                            if(quantidade == ""){
                                ...
                                listener.onAdicionarAlimento(this@AdicionarAlimentoFragment, alimento, requireArguments().getString("refeicao")!!)
                            }
                        }
