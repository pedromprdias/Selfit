...
class DetalhesTreino : AppCompatActivity() {
        ...
        navigationView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.nav_home -> {
                    ...
                    val intent = Intent(this@DetalhesTreino, HomePage::class.java)
                ...
                R.id.nav_treinos -> {
                    ...
                    val intent = Intent(this@DetalhesTreino, ListaTreinos::class.java)
                    startActivity(intent)
                    finish()
                }
                ...
                R.id.nav_progresso -> {
                    ...
                    val intent = Intent(this@DetalhesTreino, Progresso::class.java)
                    startActivity(intent)
                    finish()
                }
                ...
                R.id.nav_exercicios -> {
                    ...
                    val intent = Intent(this@DetalhesTreino, ListaExercicios::class.java)
                    startActivity(intent)
                    finish()
                }
                //when clicking food
                R.id.nav_alimentos -> {
                    //go to food activity
                    val intent = Intent(this@DetalhesTreino, ListaAlimentos::class.java)
                    startActivity(intent)
                    finish()
                }
                ...
                R.id.nav_logout -> {
                    ...
                    val intent = Intent(this@DetalhesTreino, MainActivity::class.java)
                    startActivity(intent)
                    finish()
                }
            }
    ...
    fun setUpToolbar() {
        drawerLayout = findViewById(R.id.drawerLayoutDetalhesTreino)
        val toolbar: Toolbar = findViewById(R.id.toolbarDetalhesTreino)
        setSupportActionBar(toolbar)
        findViewById<TextView>(R.id.toolbar_title).text = " - Detalhes de Treino"
